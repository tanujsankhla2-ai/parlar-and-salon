/**
 * MRKO Beauty AI Chatbot Widget — js/chatbot.js
 * ─────────────────────────────────────────────
 * ✅  NO backend server required.
 *     Calls Google Gemini API directly from the browser.
 *
 * ➡️  SETUP: Paste your Gemini API key below (one line).
...
(() => {
    ...
    const SYSTEM_PROMPT = `You are "MRKO Concierge", a polished and sophisticated AI beauty assistant for MRKO Beauty — a premium luxury beauty salon and cosmetics brand.

Your personality:
- Warm, professional, and elegantly articulate
- Use refined, aspirational language befitting a luxury brand
...
1. **Luxe Artistry** — Flawless, high-fashion makeup for defining moments
2. **Dermal Therapy** — Advanced resurfacing & hydration with bio-serums
3. **Structural Styling** — Precision hair cuts & luxury colour by senior stylists

Pricing packages:
- **Luminous Base** — $199 (Structural Styling, Dermal Glow, Cosmetic Polish, Bio-Consult)
- **Modern Signature** — $349 (Artisan Styling, Bio-Resurfacing, Collection Artistry, MRKO Gift) ⭐ Most popular
- **Radiant Royale** — $599 (VIP Sanctuary, Full Re-Design, Master Portfolio, Personal Concierge)

Booking: Clients can use the booking form on the website or WhatsApp us at +91 89498 53554.
Sessions are by appointment — recommend booking at least 10 days in advance.

For unrelated questions, politely redirect: "As the MRKO Concierge, I'm best equipped to assist with beauty, wellness, and our luxury services."`;
    ...
    function buildWidget() {
        ...
        wrapper.setAttribute('aria-label', 'MRKO AI Chat Concierge');

        wrapper.innerHTML = `
            <!-- Toggle Bubble -->
            <button
                id="mrko-chat-toggle"
                aria-label="Open MRKO chat"
                aria-expanded="false"
                aria-controls="mrko-chat-window"
                title="Chat with MRKO Concierge"
            >
            ...
            >
                ...
                <div class="chat-header">
                    ...
                    <div class="chat-header-info">
                        <div class="chat-header-name">MRKO Concierge</div>
                ...
                <div class="chat-input-area">
                    <div class="chat-input-row">
                        <textarea
                            id="mrko-chat-input"
                            placeholder="Ask MRKO Concierge anything…"
                            rows="1"
                            maxlength="500"
                    ...
                    <p class="chat-footer-note" aria-hidden="true">✦ Powered by MRKO AI &bull; Gemini 2.0 Flash</p>
                </div>
            </div>
        `;
    ...
    function toggleChat() {
        ...
        if (isOpen && !hasShownWelcome) {
            ...
            setTimeout(() => {
                appendBotMessage(
                    "Welcome to **MRKO Beauty** ✨\n\nI'm your personal concierge. How may I elevate your experience today?\n\nFeel free to ask about our services, pricing, or book a session — I'm here for you."
                );
            }, 380);
        }
    ...
    function showTyping() {
        ...
        div.setAttribute('aria-label', 'MRKO Concierge is typing');
        div.innerHTML = `
            <div class="msg-avatar bot-avatar" aria-hidden="true"><i class="fas fa-spa"></i></div>
    ...
    async function sendMessage(text) {
        ...
        try {
            ...
            console.error('[MRKO Chatbot]', err);
        } finally {
            isTyping = false;
    ...
    function wireEvents() {
        ...
        if (waBtn) {
            waBtn.addEventListener('click', () => {
                window.open(`https://wa.me/${WHATSAPP_NUMBER}?text=Hello%20MRKO%20Beauty!%20I%27d%20like%20to%20inquire%20about%20a%20session.`, '_blank');
            });
        }
